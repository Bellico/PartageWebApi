...
namespace PartageWebApi.Models
{
    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        public ApplicationDbContext()
            : base("PartageContext", throwIfV1Schema: false)
        {
        }
        ...
        public System.Data.Entity.DbSet<PartageContext.Models.Container> Container { get; set; }
    }
}