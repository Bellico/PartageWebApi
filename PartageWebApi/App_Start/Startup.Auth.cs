...
using Owin;
using PartageWebApi.Providers;
using PartageWebApi.Models;
using PartageContext;
    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.Use(async (ctx, next) =>
            {
                ...
                ctx.Response.Headers.Add("Access-Control-Allow-Headers", new[] { "Origin, X-Requested-With, Content-Type, Accept" });
                ctx.Response.Headers.Add("Access-Control-Allow-Methods", new[] { "GET", "POST", "PUT", "DELETE" });
                await next.Invoke();
            });
